                    ...
                    <div class="bd-example bd-example-tabs">
                        <div class="d-flex justify-content-center">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-gallery-tab" data-toggle="pill" href="#pills-gallery" role="tab" aria-controls="pills-gallery" aria-expanded="true">Car Photo</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="container py-4">
                                    <div class="gallery">
                                        <?php foreach ($model['allGaleri'] as $index => $image) : ?>
                                            <?php if ($image['nama'] === $model['detail']['nama_mobil']) : ?>
                                                <div class="gallery-item">
                                                    <img src="<?= BASE_URL ?>/assets/cars-gallery/<?= $image['photo'] ?>" class="img-fluid" alt="<?= $image['nama'] ?>" data-toggle="modal" data-target="#galleryModal<?= $index ?>">
                                                </div>
