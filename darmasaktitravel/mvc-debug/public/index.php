...
Router::add('POST', '/dashboard/galeri/spesifikasi/create', DashboardController::class, 'galeriSpesifikasiCreate');
Router::add('POST', '/dashboard/galeri/spesifikasi/update', DashboardController::class, 'galeriSpesifikasiUpdate');
Router::add('POST', '/dashboard/galeri/spesifikasi/delete', DashboardController::class, 'galeriSpesifikasiDelete');
