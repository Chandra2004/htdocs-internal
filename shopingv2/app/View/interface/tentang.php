    ...
    <main class="container mx-auto px-4 py-10">
        <section class="mb-16">
            <div class="bg-white rounded-lg py-10 px-6 shadow-lg">
                <img src="<?= BASE_URL ?>/assets/img/internal/logo.png" class="w-52 mx-auto mb-6" alt="Logo KAMI Digital Printing">
                <h3 class="text-lg font-bold text-center mb-4">KAMI DIGITAL PRINTING</h3>
        ...
        <section class="mb-16">
            <div class="bg-white rounded-lg py-10 px-6 shadow-lg">
                <h3 class="text-lg font-bold text-center mb-4">Visi dan Misi</h3>
                <h4 class="text-md font-semibold mb-2">Visi</h4>
                <p class="mb-4 indent-5 text-gray-600">Menjadi perusahaan penyedia jasa layanan yang mampu memberikan pelayanan dengan kualitas terbaik dan selalu mengedepankan profesionalitas kepada perusahaan atau kepada instansi mitranya.</p>
                <h4 class="text-md font-semibold mb-2">Misi</h4>
                <p class="mb-4 indent-5 text-gray-600">memberikan pelayanan yang profesional dan berkualitas kepada pelanggan dengan tolak ukur yaitu :</p>
                <ul class="list-disc pl-6 text-gray-600">
                    <li class="mb-2">Kepuasan mitra kerja.</li>
                    <li class="mb-2">Memberikan pelayanan yang terbaik.</li>
                    <li class="mb-2">Citra yang baik.</li>
                </ul>
            </div>
        </section>
        ...
        <section class="mb-16">
            <div class="bg-white rounded-lg py-10 px-6 shadow-lg">
                <h3 class="text-lg font-bold text-center mb-4">Pencapaian</h3>
                <ol class="relative border-s border-gray-200">
                    <?php foreach ($model['milestone'] as $milestone) : ?>
                        <?php
                            $timestamp = $milestone["date_milestone"];
                        ...
                        <li class="mb-10 ms-4">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900"><?= $milestone['name_milestone'] ?></h3>
                            <p class="text-base font-normal text-gray-500 line-clamp-3"><?= $milestone['description_milestone'] ?></p>
                        </li>
                    <?php endforeach; ?>
                </ol>
            </div>
